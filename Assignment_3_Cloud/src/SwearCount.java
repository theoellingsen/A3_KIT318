...
public class SwearCount {
	...
	public static void main(String[] args){
		...
		String output = profanity_filter(input);
		System.out.println("You said: '" + output + "'");
	}

	//A filter for all profane words in the private array for this class. Will send a warning to the w
	public static String profanity_filter(String line){
		...
		System.out.println("This entry contains " + percent_profane + "% profanity.");
